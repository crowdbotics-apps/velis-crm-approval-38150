...
## Project Structure
    ...
    ├── velis_crm_approval_38150  # Django project configurations
...
1. Clone this repo and `cd velis_crm_approval_38150`
...
2. Clone this repo and `cd velis_crm_approval_38150`
